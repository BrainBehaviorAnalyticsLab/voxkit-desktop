...
class CategoryListItem(QWidget):
    ...
    def __init__(self, item_key, item_data, parent=None):
        ...
        self.path = item_data.get("model_path", "Unknown") if isinstance(item_data, dict) else ""
        self.date = item_data.get("download_date", "Unknown") if isinstance(item_data, dict) else ""
...
class CategoricalListWidget(QWidget):
    ...
    def update_display(self):
        ...
        for item_data in category_data:
            ...
            item_widget = CategoryListItem(current_category, item_data)
