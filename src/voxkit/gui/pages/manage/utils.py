...
def handle_export(parent_widget, folder_name: str, selected_items: list, data: dict, current_category: str):
    """
    ...
    try:
        ...
        if copied_count == len(selected_items):
            ...
            message = f"Exported {copied_count}/{len(selected_items)} item(s) to:\n{export_folder}\n\n"
...
if __name__ == "__main__":
    ...
    sample_data = {
        'MFA Models': {
            ...
            'german_mfa': {
                'path': '/Users/beckett/models/mfa/german_mfa',
                'date': '2025-02-20'
            },
        },
        'W2TG Models': {
            'charsiu_en': {
                'path': '/Users/beckett/models/w2tg/charsiu_en',
                'date': '2025-04-05'
            },
        }
    }
